...
# 게임 종료 메시지
# TimeOut 시간초과 실패 / mission complete 성공 / game over 캐릭터 공에 맞음
    ...
    for ball_index, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:  # 가장 작은 공이 아니면 2개로 쪼개진다.
                    # 현재 공 크기 정보를 가지고 온다
            ...
            continue  # 안쪽 for문의 조건이 맞지 않으면 continue, 바깥 for 문 계속 수행
        break  # 안쪽 for문에서 break를 만나면 여기로 진입 가능, 2중 for문 탈출
